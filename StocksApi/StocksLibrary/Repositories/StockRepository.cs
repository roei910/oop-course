...
namespace StocksLibrary.Repositories
{
    public class StockRepository : IStockRepository
    {
        ...
        private async Task UpdateStocksHistoryAsync()
        {
            ...
            await _stockHistoriesDal.UpdateStocksHistoryAsync(lastMarketOpenDateTime);
        }
