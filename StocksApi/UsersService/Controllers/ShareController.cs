...
namespace UsersService.Controllers
{
    ...
    public class ShareController : Controller
    {
        ...
        [HttpDelete]
        public async Task<IActionResult> RemoveShareAsync([FromBody] ShareSale shareSale)
        {
        ...
        public async Task<IActionResult> AddWatchingStockAsync([FromBody] WatchingStockAction watchingStockAction)
        {
        ...
        public async Task<IActionResult> RemoveWatchingStockAsync([FromBody] WatchingStockAction watchingStockAction)
        {
            var found = await _userRepository.GetAsync(watchingStockAction.Email);
        ...
        public async Task<IActionResult> UpdateWatchingStockNoteAsync([FromBody] WatchingStockAction watchingStockAction)
        {
